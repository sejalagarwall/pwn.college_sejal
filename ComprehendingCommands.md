...
### New Learnings
I got to practice cd, ls, and cat commands more and I brushed up my concepts about how they work.
...
### Solve
**Flag:** `pwn.college{wUj6BjDZkY_P2to138TD9qsmqCl.QXxMDO0wCN2gjNzEzW}`

I changed directories and created a new directory in it. I created a new file in the new directory. 
```
...
Success! Here is your flag:
pwn.college{wUj6BjDZkY_P2to138TD9qsmqCl.QXxMDO0wCN2gjNzEzW}
```

### New Learnings
I learnt how to create and delete directories and revised creating a new file in said directory.
...
### Solve
**Flag:** `pwn.college{I7EPmslQ9pDf1ggG8vOs1ywWDWq.QXyMDO0wCN2gjNzEzW}`

I got stuck at first because I hadn't changed directory to /. After changing, I used the find command to search for the flag file. I began checking all the ones that showed no error. I found the file on the second try.
```
...
./opt/linux/linux-5.4/drivers/iio/temperature/flag
...
hacker@commands~finding-files:/$ ls ./opt/linux/linux-5.4/drivers/iio/temperature/flag
./opt/linux/linux-5.4/drivers/iio/temperature/flag
hacker@commands~finding-files:/$ cat ./opt/linux/linux-5.4/drivers/iio/temperature/flag
pwn.college{I7EPmslQ9pDf1ggG8vOs1ywWDWq.QXyMDO0wCN2gjNzEzW}
```
...
### Solve
**Flag:** `pwn.college{ca75em501YNgCT2j_KL6UoLe0v6.QX5ETN1wCN2gjNzEzW}`

I understood that I have to make ~/not-the-flag point to /flag so that it reads the actual flag. I got stuck when it said a file already exists. I took the help of AI and removed the file contents and added the reference to /flag.
```
...
pwn.college{ca75em501YNgCT2j_KL6UoLe0v6.QX5ETN1wCN2gjNzEzW}
```

### New Learnings
I learnt about linking a file, hard links, soft links and their uses. 
